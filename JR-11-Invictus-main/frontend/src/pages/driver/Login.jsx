...
const LoginDriver= () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch("http://localhost:5000/api/v1/driverAuth/login", {
        method: "POST",
      ...
      if (response.ok) {
        ...
        navigate("/driver/home"); // Redirect to home after login
      } else {
        alert(data.error);
      }
    } catch (error) {
  ...
  return (
    <div className="bg-gray-50 min-h-screen p-4">
      ...
      <div className="relative mb-6">
        ...
        <h1 className="text-4xl font-bold p-8 relative z-10">Login as Driver</h1>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="text-center text-lg text-gray-500 mt-8">
          ...
          <a href="/driver/signup" className="text-blue-500 ml-2">Sign up</a>
        </div>
        <div className="text-center text-lg text-gray-500 mt-8">
          Are u a Passenger??
